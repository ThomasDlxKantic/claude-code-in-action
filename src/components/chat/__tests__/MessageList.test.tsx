...
test("MessageList displays file path when tool is invoked with path argument", () => {
  const messages: Message[] = [
    {
      id: "1",
      role: "assistant",
      ...
      parts: [
        { type: "text", text: "Creating your component..." },
        {
          ...
          toolInvocation: {
            ...
            args: { path: "/App.jsx", command: "create" },
            toolName: "str_replace_editor",
            state: "result",
...
test("MessageList displays file path for file_manager tool", () => {
  const messages: Message[] = [
    {
      id: "1",
      role: "assistant",
      ...
      parts: [
        {
          ...
          toolInvocation: {
            ...
            args: { path: "/components/Card.jsx", command: "delete" },
...
test("MessageList handles tool invocation without path argument", () => {
  const messages: Message[] = [
    {
      id: "1",
      role: "assistant",
  ...
  // No file path should be displayed
  const container = screen.getByText("some_tool").closest(".rounded-lg");
